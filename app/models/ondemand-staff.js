...
var ondemandSchema = require('mongoose').model('user').schema.extend({
...
var OndemandStaff = mongoose.model('ondemand-staff', ondemandSchema);


module.exports=OndemandStaff;
